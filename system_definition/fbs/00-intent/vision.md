...
- The current solution remains traceable through the package `system_definition/` tree
...
- Feeds: `system_definition/fbs/01-product/product-commitments.md`
- Informs: `system_definition/fbs/00-intent/use-cases.md`

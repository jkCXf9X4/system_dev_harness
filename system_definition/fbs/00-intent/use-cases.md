...
- Planning helpers: find relevant files, create checklistable requirements, and extract architecture guardrails when needed. The planner records test strategy and system-definition placement directly in the work order.
...
- Product architect: protects product behavior, system-definition placement, durable decisions, and traceability.
...
- test obligations and system-definition guidance
...
- system-definition source docs when the review needs product context
...
- UC-001 through UC-014 feed `system_definition/fbs/01-product/product-commitments.md`

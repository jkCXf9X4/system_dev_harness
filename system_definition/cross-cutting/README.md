...
This directory groups artifacts that span both the Functional Breakdown Structure (FBS) and the System Definition Structure (PBS). These transversal layers verify, operate, and evolve the system without belonging exclusively to the functional or physical decomposition.

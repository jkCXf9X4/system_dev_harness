...
| Property | Value |
|---|---|
| **Original Reference** | `system_definition/cross-cutting/04-verification/acceptance-criteria.md` — criterion 9 |
...
### Criterion AC-OPS-09: system_definition/ stays as source docs, not required at runtime

| Property | Value |
|---|---|
| **Original Reference** | `cross-cutting/05-operation/deployment-process.md` — Requirement 2 |
| **Scope** | `cross-cutting/05-operation/deployment-process.md` |
| **Description** | The package `system_definition/` tree must remain source documentation for this repository and must not be required at runtime in target repositories. |
| **Verification** | Confirm deployment excludes `system_definition/` from the runtime payload. Confirm workflow agents do not require `system_definition/` to be present in target repositories. |
...
| **Scope** | `cross-cutting/05-operation/deployment-process.md` |
| **Description** | The copied payload must include the agent prompts, workflow policy, reusable prompt templates, system-definition guidance for agents, and package-local runtime dependency metadata needed by OpenCode. |
| **Verification** | Confirm the deployment payload contains agent prompt files, workflow policy files, reusable template files, agent-relevant system-definition guidance, and runtime dependency metadata. |
...
- Feeds from: `system_definition/cross-cutting/04-verification/acceptance-criteria.md` (centralized criteria), `system_definition/cross-cutting/05-operation/runbook.md` (operational requirements), `system_definition/cross-cutting/05-operation/deployment-process.md` (deployment requirements)

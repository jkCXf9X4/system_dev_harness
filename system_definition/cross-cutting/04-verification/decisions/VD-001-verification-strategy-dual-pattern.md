...
The system_dev_harness product uses a layered system-definition structure (FBS/PBS/cross-cutting) with seven layers (intent, product, architecture, implementation, verification, operation, evolution). Initial verification documentation was centralized in a single acceptance-criteria.md file. As the system grew, per-layer verification requirements became tightly coupled to central criteria, making it difficult to add layer-specific details without overloading the central file.
...
- `system_definition/cross-cutting/04-verification/acceptance-criteria.md` — Centralized authority
- `system_definition/fbs/00-intent/verification.md` — Intent layer extraction
- `system_definition/fbs/01-product/verification.md` — Product layer extraction
- `system_definition/pbs/02-architecture/verification.md` — Architecture layer extraction
- `system_definition/pbs/03-implementation/verification.md` — Implementation layer extraction
- `system_definition/cross-cutting/05-operation/verification.md` — Operation layer extraction
- `system_definition/cross-cutting/06-evolution/verification.md` — Evolution layer extraction

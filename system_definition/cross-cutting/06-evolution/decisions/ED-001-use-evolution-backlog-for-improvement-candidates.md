...
Use `system_definition/cross-cutting/06-evolution/candidates/` as the canonical location for backlog-ready improvement candidates. Keep one file per candidate under `system_definition/cross-cutting/06-evolution/candidates/`. Treat these files as proposed work, not implementation approval.

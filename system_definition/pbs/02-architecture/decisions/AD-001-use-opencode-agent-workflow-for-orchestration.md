...
Use OpenCode's primary-agent and subagent model as the orchestration layer. Represent guarded development roles as markdown agents under `.opencode/agents/`, with repository instructions and the system-definition source docs providing shared context.

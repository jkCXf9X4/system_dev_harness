...
- Positive: Important state is promoted into visible stage outputs, system-definition artifacts, workflow memory, or explicit handoffs instead of hidden helper history.

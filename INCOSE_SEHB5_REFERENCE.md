# INCOSE Systems Engineering Handbook v5.1 — Agent Reference
...
When a task involves systems engineering processes, life cycle models, tailoring guidance, or domain-specific SE considerations:
...
| File | Description |
|---|---|
| `INCOSE_SEHB5.pdf` | Original PDF (9.7 MB) |
| `INCOSE_SEHB5.txt` | Full extracted text (1.6 MB, 18,894 lines) |
| `README.md` | Structure overview and AI usage tips |
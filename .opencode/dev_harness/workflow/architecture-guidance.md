...
- When a task introduces a durable choice, apply `.opencode/dev_harness/systems_engineering/decision-placement.md`, `.opencode/dev_harness/systems_engineering/templates/decision-template.md`, and `.opencode/dev_harness/systems_engineering/templates/decision-log-entry-template.md` when an index is maintained.
- When architecture depends on system-definition artifacts, load only the exact `.opencode/dev_harness/systems_engineering/` files named by the caller.

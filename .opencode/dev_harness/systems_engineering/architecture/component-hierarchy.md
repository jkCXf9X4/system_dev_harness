...
> **Runtime reference copy for agent context.** Canonical source: `system_definition/breakdown-structures.md`.
> **External references:** This file adapts PBS (System Definition Structure) and FBS (Function Breakdown Structure) concepts from the INCOSE Systems Engineering Handbook for analytical use within this workflow. Descriptions are original summaries.
...
- Canonical source: `system_definition/breakdown-structures.md`

...
> **Runtime reference copy for agent context.** Canonical source: `system_definition/pbs/02-architecture/interface-contracts.md`.
...
- References architecture Stable Concepts from `system_definition/pbs/02-architecture/architecture.md` (agent roles, handoff boundaries, completion model)

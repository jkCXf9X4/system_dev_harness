...
> **Runtime reference copy for agent context.** Canonical source: `system_definition/pbs/02-architecture/sequence-parametric.md`.
...
- Parametric constraints C01, C04, C05 are derived from `system_definition/pbs/02-architecture/architecture.md` (completion model, control flow)

...
> **Runtime reference copy for agent context.** Canonical source: `product-breakdown/pbs/02-architecture/interface-contracts.md`.
...
- References architecture Stable Concepts from `product-breakdown/pbs/02-architecture/architecture.md` (agent roles, handoff boundaries, completion model)

...
When the task touches product breakdown artifacts, apply `.opencode/dev_harness/workflow/product-breakdown-work.md` and load only directly needed layer or support files.

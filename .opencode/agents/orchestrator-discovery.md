...
When the task touches system-definition artifacts, apply `.opencode/dev_harness/workflow/product-breakdown-work.md` and load only directly needed layer or support files.
...
- system-definition guidance files loaded, when relevant

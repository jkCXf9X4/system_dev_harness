...
Designate `product-breakdown/cross-cutting/04-verification/acceptance-criteria.md` as the authoritative verification index for the system:
...
- `product-breakdown/cross-cutting/04-verification/acceptance-criteria.md` — Authoritative index
- All per-layer `verification.md` files — Extract from and reference this index
- `product-breakdown/cross-cutting/04-verification/test-strategy.md` — References this index
- `product-breakdown/cross-cutting/04-verification/traceability-matrix.md` — References this index

...
| --- | --- | --- | --- |
| product-breakdown/dev-harness synchronization drift | Medium | High | Product-breakdown source docs must stay aligned with `.opencode/dev_harness/product-breakdown/`. Currently synchronized manually. |

...
| WP-15 | Product breakdown documentation | PBS: Write and maintain product-breakdown/ artifacts across all layers | L | WP-14 | Ongoing |
...
- Feeds from: `product-breakdown/breakdown-structures.md` (WBS section), `product-breakdown/cross-cutting/06-evolution/breakdown-structures.md` (via IMP-016)

...
3. Extract product-breakdown loading, placement, traceability, and decision-record rules into `.opencode/dev_harness/workflow/product-breakdown-work.md`.
...
- Candidate capture, memory, helper selection, parallel helper execution, output schema, boundaries, and product-breakdown rules are separately loadable.

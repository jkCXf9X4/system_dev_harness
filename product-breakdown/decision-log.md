...
| --- | --- | --- | --- | --- | --- |
| AD-001 | Use OpenCode Agent Workflow For Orchestration | Architecture | Accepted | `product-breakdown/02-architecture/decisions/AD-001-use-opencode-agent-workflow-for-orchestration.md` | Product commitments PC-001 through PC-010, Use cases UC-001 through UC-014 |
...
| AD-004 | Decline Adding Agent SKILLS To Primary Agents | Architecture | Declined | `product-breakdown/02-architecture/decisions/AD-004-decline-adding-agent-skills-to-primary-agents.md` | KM-004, UC-001 through UC-014 |

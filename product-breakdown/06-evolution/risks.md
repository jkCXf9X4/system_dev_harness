...
| --- | --- | --- | --- |
| product-breakdown/template synchronization drift | Medium | High | Product-breakdown source docs must stay aligned with `.opencode/templates/product-breakdown/`. Currently synchronized manually. |

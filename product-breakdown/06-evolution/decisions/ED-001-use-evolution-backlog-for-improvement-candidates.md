...
Use `product-breakdown/06-evolution/backlog/` as the canonical location for backlog-ready improvement candidates. Keep a single backlog overview at `product-breakdown/06-evolution/backlog/improvement-backlog.md` and one file per candidate under `product-breakdown/06-evolution/backlog/candidates/`. Treat these files as proposed work, not implementation approval.

...
- Backlog-worthy improvement candidates are persisted to `product-breakdown/06-evolution/candidates/` by builder candidate-capture mode before the builder returns, without changing implementation files.

...
Keep persistent mistake memory in `.opencode/dev_harness_memories/lessons.md` and load it through the dev harness workflow context. Use stable lesson ids, prevention rules, and completion checks so reviewers can refer to them consistently.

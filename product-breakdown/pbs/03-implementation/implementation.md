...
| Improvement candidates and future work seeds | Accepted candidates in `product-breakdown/cross-cutting/06-evolution/candidates/`, then selected/done evolution files | `orchestrator-builder` in candidate-capture mode. |

...
This document extracts and scopes the acceptance criteria from `product-breakdown/cross-cutting/04-verification/acceptance-criteria.md` that are relevant to the Intent layer. It co-locates intent verification with the intent artifacts it verifies (vision, use cases), following the INCOSE §1.3.5 horizontal-view model.
...
| Property | Value |
|---|---|
| **Original Reference** | `product-breakdown/cross-cutting/04-verification/acceptance-criteria.md` — criterion 1 |
...
| Property | Value |
|---|---|
| **Original Reference** | `product-breakdown/cross-cutting/04-verification/acceptance-criteria.md` — criterion 3 |
...
| Property | Value |
|---|---|
| **Original Reference** | `product-breakdown/cross-cutting/04-verification/acceptance-criteria.md` — criterion 4 |
...
### Criterion AC-INTENT-04: Product source info stays in product-breakdown/

| Property | Value |
|---|---|
| **Original Reference** | `product-breakdown/cross-cutting/04-verification/acceptance-criteria.md` — criterion 15 |
| **Scope** | `fbs/00-intent/vision.md`, `fbs/00-intent/use-cases.md` |
| **Description** | Product source information, scope, stable decisions, and traceability must remain in `product-breakdown/`. Intent artifacts (vision, use cases) are product source and belong in this directory. |
| **Verification** | Confirm all intent-layer source documents reside under `product-breakdown/fbs/00-intent/`. No intent source information should be duplicated outside `product-breakdown/`. |

### Criterion AC-INTENT-05: Runnable guidance stays in docs/ without duplicating product text

| Property | Value |
|---|---|
| **Original Reference** | `product-breakdown/cross-cutting/04-verification/acceptance-criteria.md` — criterion 16 |
| **Scope** | `fbs/00-intent/vision.md`, `fbs/00-intent/use-cases.md` |

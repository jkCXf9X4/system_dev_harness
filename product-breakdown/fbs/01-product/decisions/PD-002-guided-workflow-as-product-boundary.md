...
- **Prompt-only product**: Just the agent prompt files without workflow policy or product-breakdown context — insufficient for traceable, guarded delivery.
...
- `product-breakdown/README.md` — Scope and boundary documentation
- `product-breakdown/pbs/02-architecture/architecture.md` — Boundaries section
...
No product-breakdown artifact describes the product as including runtime infrastructure or external service dependencies. All agent prompts reference the guarded chain, not execution infrastructure.

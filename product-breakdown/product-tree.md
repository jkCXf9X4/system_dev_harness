...
This document provides a formal Product Breakdown Structure (PBS) for the `system_dev_harness` System of Interest (SoI). It follows INCOSE §1.3.5 hierarchy conventions: each element declares its `element_type` (atomic or decomposable) and its parent subordination.
...
graph TD
    ...
    L03 --> L03_IMD1["IMD-001-use-versioned-markdown-for-mistake-memory.md<br/>(element_type: atomic)"]
    L03 --> L03_IMD2["IMD-002-copy-product-breakdown-guidance-into-agent-payload.md<br/>(element_type: atomic)"]
    L03 --> L03_IMD3["IMD-003-use-repo-local-workflow-memory.md<br/>(element_type: atomic)"]
...
system_dev_harness [decomposable]
 ...
 |    +-- README.md [atomic]
 |
 +-- pbs/ (Product Breakdown Structure) [decomposable]
...
| `pbs/` (Product Breakdown Structure) | `system_dev_harness` | PBS grouping — physical decomposition |
...
|---|---|---|
| `system_dev_harness` | `/home/eriro/pwa/2_work/system_dev_harness/` |
| `fbs/` | `product-breakdown/fbs/` |
| `fbs/00-intent/` | `product-breakdown/fbs/00-intent/` |
| `fbs/01-product/` | `product-breakdown/fbs/01-product/` |
| `pbs/` | `product-breakdown/pbs/` |
| `pbs/02-architecture/` | `product-breakdown/pbs/02-architecture/` |
| `pbs/02-architecture/decisions/` | `product-breakdown/pbs/02-architecture/decisions/` |
| `pbs/03-implementation/` | `product-breakdown/pbs/03-implementation/` |
| `cross-cutting/` | `product-breakdown/cross-cutting/` |
| `cross-cutting/04-verification/` | `product-breakdown/cross-cutting/04-verification/` |
| `cross-cutting/04-verification/decisions/` | `product-breakdown/cross-cutting/04-verification/decisions/` |
| `cross-cutting/05-operation/` | `product-breakdown/cross-cutting/05-operation/` |
| `cross-cutting/05-operation/decisions/` | `product-breakdown/cross-cutting/05-operation/decisions/` |
| `cross-cutting/06-evolution/` | `product-breakdown/cross-cutting/06-evolution/` |
| `cross-cutting/06-evolution/decisions/` | `product-breakdown/cross-cutting/06-evolution/decisions/` |
| `cross-cutting/06-evolution/candidates/` | `product-breakdown/cross-cutting/06-evolution/candidates/` |
| `cross-cutting/06-evolution/selected/` | `product-breakdown/cross-cutting/06-evolution/selected/` |
| `cross-cutting/06-evolution/done/` | `product-breakdown/cross-cutting/06-evolution/done/` |
| Root artifacts | `product-breakdown/` (root) |

## Trace Links

- Feeds from: `product-breakdown/README.md` (directory structure), `product-breakdown/traceability-map.md` (trace chain), `product-breakdown/breakdown-structures.md` (FBS/PBS/WBS relationships)

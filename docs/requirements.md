...
| FR-008 | The harness shall run a reviewer council across requirements, architecture, QA, completeness, and known mistakes. |
...
| C-006 | Persistent mistake memory starts as versioned markdown. |

...
| PC-010 | The workspace shall route small bounded tasks directly to OpenCode's built-in build agent when the full guardrail workflow is unnecessary. | Vision, UC-001, UC-013 |
...
- PC-010 satisfies a lightweight build-agent handoff for trivial or low-risk tasks.
